...
- It **finishes and exits** (not a server) — prints `Ingested N contextual chunks, N clauses, N BM25 records.` when done (currently ~385 chunks / ~368 clauses, after the finer Appendix C segmentation).
